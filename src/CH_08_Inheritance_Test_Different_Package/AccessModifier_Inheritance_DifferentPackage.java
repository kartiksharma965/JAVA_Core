...
public class AccessModifier_Inheritance_DifferentPackage extends Example_1{
	...
	public static void main(String[] args) {
		...
		AccessModifier_Inheritance_DifferentPackage obj = new AccessModifier_Inheritance_DifferentPackage();
		...
		/* Rule = We can access Public member from different classes and package. */
		Example_1 obj2 = new  AccessModifier_Inheritance_DifferentPackage();
